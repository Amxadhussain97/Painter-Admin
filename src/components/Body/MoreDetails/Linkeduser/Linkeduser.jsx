...
import { LinkeduserForm } from './LinkeduserForm';
...
export default function Linkeduser(props) {
    ...
    useEffect(async () => {
        await fetch(`http://amaderlab.xyz/api/linkedusers?user_id=${id}`, {
            method: "GET",
            headers: {
    ...
    const columns = [
        ...
        { title: "ID", field: "linkeduser", editable: false },
        ...
        },
        {
            title: 'MoreInfo',
            render: rowData => {
                return <NavLink style={{ cursor: 'pointer' }} to={`/home/info/personalinfo?user=${rowData.linkeduser}`}><MoreIcon /></NavLink>
            ...
            <MaterialTable
                ...
                editable={{
                    ...
                    onRowDelete: selectedRow => new Promise((resolve, reject) => {
                        ...
                        fetch(`http://amaderlab.xyz/api/linkedusers/${selectedRow.linkeduser}?user_id=${id}`, {
                    ...
                    onRowUpdate: (updatedRow, oldRow) => new Promise((resolve, reject) => {
                        ...
                        let result = fetch("http://amaderlab.xyz/api/users/" + updatedRow.linkeduser, {
                            method: "POST",
                            headers: {
                                "Authorization": `Bearer ${token}`,
