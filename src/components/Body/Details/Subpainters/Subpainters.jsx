...
import { SubpainterForm } from './SubpainterForm';
...
export default function Subpainters(props) {
    ...
    const [subpainters, setSubpainters] = useState();
    ...
    useEffect(async () => {
        await fetch(`http://amaderlab.xyz/api/subpainters?user_id=${id}`, {
            method: "GET",
            headers: {
    ...
    async function addOrEdit(subpainter, resetForm) {
        const formData = new FormData();
        formData.append('phone', subpainter.phone);
